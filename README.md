...
- 运行/tests/simple-benchmark.php
  ...
  - 结果如下：
    ...
    1^ "count: 10000"
    2^ "interval: 1 μs"
    ^ "redis: 7.9448239803314"
    ^ "cache: 0.65310287475586"
    ^ "-----------------------------------"
    1^ "count: 10000"
    2^ "interval: 10 μs"
    ^ "redis: 8.0218880176544"
    ^ "cache: 0.7279999256134"
    ^ "-----------------------------------"
    1^ "count: 10000"
    2^ "interval: 100 μs"
    ^ "redis: 8.9661190509796"
    ^ "cache: 1.7269020080566"
    ^ "-----------------------------------"
    1^ "count: 10000"
    2^ "interval: 1000 μs"
    ^ "redis: 18.141793966293"
    ^ "cache: 11.27095913887"
    ^ "-----------------------------------"
    ```
